'''
source:
https://github.com/kimiyoung/transformer-xl/blob/master/pytorch/utils/adaptive_softmax.py

might be replaced by https://pytorch.org/docs/stable/_modules/torch/nn/modules/adaptive.html
'''
